class enemies {
  ...
  constructor() {
    this.list = [
      { id: 0, name: "Скелет", level: 1, hp: 30, damage: 5, armor: 1, experience: 10, time: 1000 },
      { id: 1, name: "Зомби", level: 1, hp: 50, damage: 3, armor: 1, experience: 10, time: 1000 },
      { id: 2, name: "Гоблин", level: 1, hp: 40, damage: 4, armor: 1, experience: 10, time: 1000 },
      { id: 3, name: "Орк", level: 2, hp: 70, damage: 8, armor: 2, experience: 30, time: 1000 },
      { id: 4, name: "Волк", level: 2, hp: 50, damage: 10, armor: 2, experience: 30, time: 1000 },
      { id: 5, name: "Скелет-лучник", level: 2, hp: 30, damage: 15, armor: 2, experience: 30, time: 1000 },
