class enemies {
  ...
  constructor() {
    this.list = [
      ...
      { id: 9, name: "Наемник", level: 4, hp: 120, damage: 40, armor: 4, evasion: 30, critChance: 30, critPower: 70, experience: 110, image: "mercenary.webp", time: 1000 },
      { id: 10, name: "Шаман орков", level: 4, hp: 120, damage: 35, armor: 7, evasion: 20, critChance: 20, critPower: 50, experience: 110, image: "orc_shaman.webp", time: 1000 },
      { id: 11, name: "Кентавр", level: 4, hp: 130, damage: 30, armor: 10, evasion: 10, critChance: 20, critPower: 50, experience: 110, image: "centaur.webp", time: 1000 },
