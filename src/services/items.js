class items {
  constructor() {
    ...
    this.armorList = [
      { id: 1010, name: "Железный шлем", category: "helmet", armor: 3, hp: 15, durability: 10, requiredLevel: 1, price: 45 },
      { id: 1011, name: "Железная кираса", category: "upper", armor: 6, hp: 15, durability: 10, requiredLevel: 1, price: 60 },
      { id: 1012, name: "Железные сапоги", category: "boots", armor: 3, hp: 15, durability: 10, requiredLevel: 1, price: 45 },
      { id: 1013, name: "Стальной шлем", category: "helmet", armor: 10, hp: 50, durability: 25, requiredLevel: 4, price: 120 },
      { id: 1014, name: "Стальная кираса", category: "upper", armor: 15, hp: 50, durability: 25, requiredLevel: 4, price: 150 },
      { id: 1015, name: "Стальные набедренники", category: "lower", armor: 10, hp: 50, durability: 25, requiredLevel: 4, price: 120 },
      { id: 1016, name: "Стальные перчатки", category: "gloves", armor: 10, hp: 50, durability: 25, requiredLevel: 4, price: 120 },
      { id: 1017, name: "Стальные сапоги", category: "boots", armor: 10, hp: 50, durability: 25, requiredLevel: 4, price: 120 },
      { id: 1018, name: "Кожаный легий шлем", category: "helmet", armor: 5, hp: 30, evasion: 5, durability: 25, requiredLevel: 4, price: 120 },
      { id: 1019, name: "Кожаный легкий жилет", category: "upper", armor: 10, hp: 30, evasion: 5, durability: 25, requiredLevel: 4, price: 150 },
      { id: 10110, name: "Кожаные легкие штаны", category: "lower", armor: 5, hp: 30, evasion: 5, durability: 25, requiredLevel: 4, price: 120 },
      { id: 10111, name: "Кожаные легкие перчатки", category: "gloves", armor: 5, hp: 30, evasion: 5, durability: 25, requiredLevel: 4, price: 120 },
      { id: 10112, name: "Кожаные легкие сапоги", category: "boots", armor: 5, hp: 30, evasion: 5, durability: 25, requiredLevel: 4, price: 120 },
      { id: 10113, name: "Cверхпрочные ультра сапоги высшего порядка", category: "boots", damage: 50, armor: 100, hp: 1000, evasion: 50, critChance: 100, critPower: 250, durability: 100, requiredLevel: 1, price: 1 },
    ];
