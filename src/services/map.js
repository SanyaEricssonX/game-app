...
class map {
  constructor() {
    this.locationList = [
      ...
      { id: 1052, name: "Равнины древней магии", minLevel: 9, maxLevel: 12, image: "location3.webp", drop: [1030, 1031, 1033, 1034, 1036, 1037, 1038, 1039, 10312, 10313, 10314, 10315, 10316, 1042, 1048, 1049, 10410] },
      { id: 1053, name: "Туманный лес", minLevel: 13, maxLevel: 16, image: "location4.webp", drop: [1030, 1031, 1034, 1035, 1036, 1037, 1038, 1039, 10312, 10315, 10316, 10317, 10318, 1043, 1048, 10411, 10412] },
      { id: 1054, name: "Заснеженный перевал", minLevel: 17, maxLevel: 20, image: "location5.webp", drop: [1030, 1031, 1035, 1036, 1037, 1038, 1039, 10312, 10315, 10316, 10319, 10320, 10321, 10322, 10323, 10324, 1048, 10413, 10414, 10415, 10416, 10417] },
    ];
  }
